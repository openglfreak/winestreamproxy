...
typedef void (*proxy_running_callback)(logger_instance* logger, proxy_data* proxy);

extern BOOL create_proxy(logger_instance* logger, connection_paths paths, HANDLE exit_event /* Must be manual-reset. */,
